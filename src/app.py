...
activities = {
    ...
    "Basketball Club": {
        "description": "Develop basketball skills through practice sessions and scrimmages",
    ...
    "Painting Workshop": {
        "description": "Learn painting techniques using watercolor, acrylic, and mixed media",
        "schedule": "Fridays, 2:30 PM - 4:00 PM",
        "max_participants": 15,
        "participants": ["amelia@mergington.edu", "harper@mergington.edu"]
    },
    "Debate Society": {
        "description": "Practice public speaking and structured argumentation on current topics",
